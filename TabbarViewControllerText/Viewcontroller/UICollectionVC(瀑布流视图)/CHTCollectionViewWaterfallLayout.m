...
- (void)prepareLayout {
  ...
  for (NSInteger section = 0; section < numberOfSections; ++section) {
    ...
    for (idx = 0; idx < itemCount; idx++) {
      ...
      CGFloat itemViewTitleHeight = [self.delegate collectionItemHeightsizeForItemAtIndexPath:indexPath];
      CGFloat itemHeight = 0;
      if (itemSize.height > 0 && itemSize.width > 0) {
        itemHeight = CHTFloorCGFloat(itemSize.height * itemWidth / itemSize.width)+itemViewTitleHeight;
      }
